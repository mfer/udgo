...
public class PrimMST {
    ...
    /**
     * Returns the biggest edge weight in a minimum spanning tree (or forest).
     * @return the biggest edge weight in a minimum spanning tree (or forest)
     */
    public double biggest() {
        double biggest = 0.0;
        for (Edge e : edges())
        	if(e.weight()>biggest) biggest = e.weight();
        return biggest;
    }
